  ...
  return (
    <div className="App">
        ...
        <section id='profile'>
          ...
          <div className='sectionText'>
            ...
            <div id = 'socialsContainer'>
              <img src='/linkedin.png' alt='My LinkedIn profile' className='socialsIcon socialsLinkedInIcon' onClick={openLinkedIn}></img>
              <img src='/github.png' alt='My GitHub profile' className='socialsIcon socialsGithubIcon' onClick={openGithub}></img>
              <img src='/email.png' alt='My email' className='socialsIcon socialsEmailIcon' onClick={sendEmail}></img>
            </div>
          </div>
        ...
        <section id='about'>
          ...
          <div className='sectionContainer'>
            ...
            <div className='profilePictureCropper'>
              <img className='profilePicture' src='/profile-pic.png' alt='Gurjog Singh Profile Picture'></img>
            </div>
          </div>
          ...
          <img src='/arrow.png' alt='Arrow Icon' className='socialsIcon arrow' onClick={downAboutToExperience}></img>
        </section>
        <section id='experience'>
            ...
            <div className='aboutContainers'>
              <div className='detailsContainer'>
                <div className='experienceDetails'>
                  <img className ='experienceLogo' src='/pcl-logo.jpg'></img>
          ...
          <img src='/arrow.png' alt='Arrow Icon' className='socialsIcon arrow' onClick={downExperienceToProjects}></img>
        </section>
        <section id='projects'>
            ...
            <div className='aboutContainers projectsContainers'>
              <div className='detailsContainer colorContainer singleProjectContainer'>
                <div className='articleContainer'>
                  <img src='/flowergirl-picture.png' alt='FlowerGirl' className='projectImage'></img>
                </div>
                ...
                <div className='buttonContainer'>
                <img src='/github.png' alt='My GitHub profile' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('https://github.com/gurjogsingh/silverpalmfood')}}></img>
                <img src='/open.png' alt='Link to' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('https://youtu.be/6VbGz163z_M')}}></img>
                </div>
              </div>
              <div className='detailsContainer colorContainer singleProjectContainer'>
                <div className='articleContainer'>
                  <img src='/silverpalmfood-picture.png' alt='Silver Palm Food' className='projectImage'></img>
                </div>
                ...
                <div className='buttonContainer'>
                <img src='/github.png' alt='My GitHub profile' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('https://github.com/gurjogsingh/silverpalmfood')}}></img>
                <img src='/open.png' alt='Link to' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('/silverpalmfood.pdf')}}></img>
                </div>
              </div>
              <div className='detailsContainer colorContainer singleProjectContainer'>
                <div className='articleContainer'>
                  <img src='/tartan-picture.avif' alt='Tartan Smart Home Platform' className='projectImage'></img>
                </div>
                ...
                <div className='buttonContainer'>
                <img src='/github.png' alt='My GitHub profile' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('https://github.com/cmput402-w23/tartan-groupy2/')}}></img>
                </div>
              </div>
              <div className='detailsContainer colorContainer singleProjectContainer'>
                <div className='articleContainer'>
                  <img src='/pinit-picture.png' alt='PinIt' className='projectImage'></img>
                </div>
                ...
                <div className='buttonContainer'>
                <img src='/github.png' alt='My GitHub profile' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('https://github.com/gurjogsingh/pinit')}}></img>
                <img src='/open.png' alt='Link to' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('/pinit.pdf')}}></img>
                </div>
              </div>
              <div className='detailsContainer colorContainer singleProjectContainer'>
                <div className='articleContainer'>
                  <img src='/pinit-picture.png' alt='LabNet' className='projectImage'></img>
                </div>
                ...
                <div className='buttonContainer'>
                <img src='/github.png' alt='My GitHub profile' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('https://github.com/MdderUofA/Lab-Net/')}}></img>
                </div>
              </div>
              <div className='detailsContainer colorContainer singleProjectContainer'>
                <div className='articleContainer'>
                  <img src='/bingbing-picture.png' alt='BingBing' className='projectImage'></img>
                </div>
                ...
                <div className='buttonContainer'>
                <img src='/github.png' alt='My GitHub profile' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('https://github.com/CMPUT404W22-GroupProject/social-distribution/')}}></img>
                <img src='/open.png' alt='Link to' className='socialsIcon socialsGithubIcon' onClick={() => {openGithubProject('https://youtu.be/jj_-ehar8AE')}}></img>
                </div>
              </div>
              <div className='detailsContainer colorContainer singleProjectContainer'>
                <div className='articleContainer'>
                  <img src='/portfolio-picture.png' alt='Portfolio' className='projectImage'></img>
                </div>
          ...
          <img src='/arrow.png' alt='Arrow Icon' className='socialsIcon arrow' onClick={downProjectsToContact}></img>
        </section>
        <section id='contact'>
          ...
          <div className='contactInfoUpperContainer'>
            <div className='contactInfoContainer'>
              <img src='/email.png' alt='Email Icon' className='socialsIcon contactIcon'></img>
              <p><a href='mailto:gurjog@ualberta.ca'>gurjog@ualberta.ca</a></p>
            </div>
            <div className='contactInfoContainer'>
              <img src='/linkedin.png' alt='LinkedIn Icon' className='socialsIcon contactIcon'></img>
